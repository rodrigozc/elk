...
ADD ./09-kapp.conf /etc/logstash/conf.d/09-kapp.conf
...
RUN ${KIBANA_HOME}/bin/kibana-plugin install x-pack

###############################################################################
#                          INSTALL LOGSTASH PLUGINS
###############################################################################

RUN ${LOGSTASH_HOME}/bin/logstash-plugin install logstash-filter-multiline
